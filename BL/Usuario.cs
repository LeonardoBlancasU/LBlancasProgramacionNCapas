    ...
    public class Usuario
    {
        ...
        public static ML.Result GetAllEFSP(ML.Usuario usuario)
        {
            ...
            try
            {
                using (DL_EF.LBlancasProgramacionNCapasEntities context = new DL_EF.LBlancasProgramacionNCapasEntities())
                {
                    var listaUsuarios = context.UsuarioGetAll(usuario.Nombre, usuario.ApellidoPaterno, usuario.ApellidoMaterno, usuario.Rol.IdRol).ToList();
                    if (listaUsuarios.Count > 0)
                    {
                        ...
                        foreach (var usuarioDB in listaUsuarios)
                        {
                            ...
                            usuarioItem.IdUsuario = usuarioDB.IdUsuario;
                            usuarioItem.Nombre = usuarioDB.Nombre;
                            usuarioItem.ApellidoPaterno = usuarioDB.ApellidoPaterno;
                            usuarioItem.ApellidoMaterno = usuarioDB.ApellidoMaterno;
                            usuarioItem.UserName = usuarioDB.UserName;
                            usuarioItem.Email = usuarioDB.Email;
                            usuarioItem.Password = usuarioDB.Password;
                            usuarioItem.FechaNacimiento = usuarioDB.FechaNacimiento.Value.ToString("dd-MM-yyyy");
                            usuarioItem.Sexo = usuarioDB.Sexo;
                            usuarioItem.Telefono = usuarioDB.Telefono;
                            usuarioItem.Celular = usuarioDB.Celular;
                            usuarioItem.Estatus = usuarioDB.Estatus;
                            usuarioItem.CURP = usuarioDB.CURP;
                            usuarioItem.Imagen = usuarioDB.Imagen;
                            usuarioItem.Rol = new ML.Rol();
                            usuarioItem.Rol.IdRol = usuarioDB.IdRol.Value;
                            usuarioItem.Rol.Nombre = usuarioDB.NombreRol;
                            usuarioItem.Direccion = new ML.Direccion();
                            usuarioItem.Direccion.Calle = usuarioDB.Calle;
                            usuarioItem.Direccion.NumeroExterior = usuarioDB.NumeroExterior;
                            usuarioItem.Direccion.NumeroInterior = usuarioDB.NumeroInterior;
                            usuarioItem.Direccion.Colonia = new ML.Colonia();
                            usuarioItem.Direccion.Colonia.Nombre = usuarioDB.NombreColonia;
                            usuarioItem.Direccion.Colonia.CodigoPostal = usuarioDB.CodigoPostal;
                            usuarioItem.Direccion.Colonia.Municipio = new ML.Municipio();
                            usuarioItem.Direccion.Colonia.Municipio.Nombre = usuarioDB.NombreMunicipio;
                            usuarioItem.Direccion.Colonia.Municipio.Estado = new ML.Estado();
                            usuarioItem.Direccion.Colonia.Municipio.Estado.Nombre = usuarioDB.NombreEstado;
